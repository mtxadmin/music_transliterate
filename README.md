...
И если для 1-DIN магнитолы это не очень большая проблема, достаточно переименовать все файлы во что-то вроде 001.mp3, 002.mp3 - всё равно на маленьком экранчике имена песен не показываются, то вот на большом экране хотелось бы видеть что-то более интересное, чем 001.mp3 . К сожалению, кроме транслита больше ничего придумать не получится, но всё же это будет куда более информативно, чем 001.mp3.

Также, выяснилось, что при включении-выключении магнитолы может сбрасываться опция случайного выбора треков, и плеер начинает играть файлы по порядку, как на старых кассетных плеерах. Чтобы искусственно смешать порядок воспроизведения, добавим опцию присоединения к именам случайных числовых префиксов.
